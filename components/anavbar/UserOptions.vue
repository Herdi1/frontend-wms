<template>
  <div
    class="absolute right-2 mt-2 bg-white border border-gray-200 rounded shadow-lg z-50 p-3 dark:bg-slate-700 dark:border-none"
    v-show="visible"
  >
    ...
    <div
      class="flex flex-col gap-2 w-full text-base justify-center text-gray-800 dark:text-white"
    >
      <nuxt-link to="/profil" class="dropdown-item has-icon"
      ...
      >
        ...
        <span v-else> <i class="fas fa-sign-out-alt mr-2"></i> Logout </span>
      </button>
    </div>
  </div>
</template>
