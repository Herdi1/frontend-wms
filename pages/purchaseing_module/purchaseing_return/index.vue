                      ...
                      <td>
                        ...
                        <span class="row m-0 p-0">
                          ...
                          <div class="col m-0 p-0">
                            ...
                            >
                               {{ item.purchaseing ? item.purchaseing.code  : "-" }}
                            </div>
                          </div>
                        </span>                        
                        <div
                      ...
                      <td class="text-center">
                        <div class="btn-group border border-success">                                                  
                          <button class="btn btn-sm" 
                            ...
                            v-if="!item.deleted_at && getRoles.update && item.stock_outs_count == 0">
                            <i class="fas fa-pen text-warning"></i>
                          </button>
                          <button class="btn btn-sm" 
                            @click="onTrashed(item)" 
                            v-if="!item.deleted_at && getRoles.destroy && item.stock_outs_count == 0">
...
export default {
  ...
  computed : {
    ...
    getRoles(){
      if(!this.user.parent_id){
        ...
        let main_role = this.user.group_role.roles.find(item => item.name == "purchaseing_return");
  ...
  methods : {
    ...
    onFormShow(){    
      this.$router.push("/purchaseing_module/purchaseing_return/add");
    },

    onEdit(id){
      this.$router.push("/purchaseing_module/purchaseing_return/"+id);
    },
