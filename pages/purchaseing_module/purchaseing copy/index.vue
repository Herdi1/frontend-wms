                        ...
                        >
                          ...
                          <div>
                            <i
                              class="fas fa-caret-up"
                              :class="
                                parameters.params.order == 'discount' &&
                                parameters.params.sort == 'asc'
                                  ? ''
                                  : 'light-gray'
                              "
                        ...
                        >
                          ...
                          <div>
                            <i
                              class="fas fa-caret-up"
                              :class="
                                parameters.params.order == 'grand_total' &&
                                parameters.params.sort == 'asc'
                                  ? ''
                                  : 'light-gray'
                              "
                    ...
                    >
                      ...
                      <td>
                        ...
                        >
                          <i
                            >Dibuat Oleh :
                            {{ item.user ? item.user.username : "-" }}</i
                          >
                        </div>
                      </td>
                      <td>{{ item.date }}</td>
                      <td>
                        ...
                        <span class="row m-0 p-0">
                          ...
                          <div class="col m-0 p-0">
                            <div
                              class="text-right text-info m-0 p-0"
                              style="font-size: 12px !important; color: dimgrey"
                            >
                              {{
                                item.po_supplier ? item.po_supplier.code : "-"
                              }}
                            </div>
                          </div>
                        </span>
                      ...
                      <td>
                        {{ item.discount | formatPrice }}
                        <span v-if="item.discount_type == 'NOMINAL'">
                          *RP
                        </span>
                        <span v-else> % </span>
                      </td>
                      ...
                      <td class="text-center">
                        <div class="btn-group border border-success">
                          <button
                            ...
                            v-if="
                              !item.deleted_at &&
                              item.debt_payments_count == 0 &&
                              item.purchaseing_returns_count == 0 &&
                              item.stock_ins_count == 0 &&
...
export default {
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/purchaseing_module/purchaseing/add");
    },

    onEdit(id) {
      this.$router.push("/purchaseing_module/purchaseing/" + id);
    },
