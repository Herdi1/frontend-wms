            ...
            <div class="receipt-main">
              ...
              <div class="row mt-2">
                ...
                <div class="col-md-6 float-right ">
                  <div class="receipt-right text-right">
                    ...
                    <p><b>Po Supplier :</b> {{ parameters.form.po_supplier ? parameters.form.po_supplier.code : '-' }} </p>
              ...
              <div>
                <table class="table table-striped table-sm vld-parent mt-3">
                  ...
                  <tbody>
                    <tr v-for="item in parameters.form.purchaseing_details" :key="item.id">
                    ...
                    <tr v-if="!parameters.form.purchaseing_details.length">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <p>
                          {{ parameters.form.discount | formatPrice }}   
                        </p>
