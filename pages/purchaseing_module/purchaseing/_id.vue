        ...
        <div class="card-body">
          <div class="card-title">
            <div class="d-flex justify-content-between">
              <h6>{{ isEditable ? "Edit" : "Tambah" }} Tanda Terima</h6>
          ...
          <ValidationObserver v-slot="{ invalid, validate }" ref="form-validate">
            <form @submit.prevent="() => console.log('Submit')" autocomplete="off">
                    ...
                    <div class="form-group" slot-scope="{ errors, valid }">
                      <div class="row">
                        ...
                        <div class="col-sm-8 align-self-center ml-0 pl-0">
                          <input type="text" class="form-control" name="code" v-model="form.code" :class="errors[0] ? 'is-invalid' : valid ? 'is-valid' : ''
                            " disabled />
                    ...
                    <div class="form-group" slot-scope="{ errors, valid }">
                      <div class="row">
                        ...
                        <div class="col-sm-10 align-self-center ml-0 pl-0">
                          <input type="date" class="form-control" name="date" v-model="form.date" :class="errors[0] ? 'is-invalid' : valid ? 'is-valid' : ''
                            " />
                ...
                <div class="col-sm-3">
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-sm-8 align-self-center ml-0 pl-0">
                        <input type="date" class="form-control" name="due_date" v-model="form.due_date"
                  ...
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-sm-10 align-self-center mr-0 pl-0">
                        <v-select label="code" :loading="isLoadingGetPoSupplier" :options="lookup_po_suppliers.data"
                          :filterable="false" @search="onGetPoSupplier" @input="onSetPoSupplier"
                          v-model="form.po_supplier_id" :disabled="isEditable">
                          ...
                          <template #search="{ attributes, events }">
                            <input class="vs__search" :required="!form.po_supplier_id" v-bind="attributes"
                              v-on="events" />
                          </template>
                          <li slot-scope="{ search }" slot="list-footer" class="d-flex justify-content-between"
                            v-if="lookup_po_suppliers.data.length || search">
                            <span v-if="lookup_po_suppliers.current_page > 1" @click="onGetPoSupplier(search, false)"
                              class="
                                flex-fill
                                bg-primary
                                text-white text-center
                              " style="cursor: pointer">Sebelumnya</span>
                            <span v-if="lookup_po_suppliers.last_page >
                              lookup_po_suppliers.current_page
                              " @click="onGetPoSupplier(search, true)" class="
                                flex-fill
                                bg-primary
                                text-white text-center
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-sm-10 align-self-center ml-0 pl-0">
                        <v-select label="name" :loading="isLoadingGetSupplier" :options="lookup_suppliers.data"
                          :filterable="false" @search="onGetSupplier" @input="onSetSupplier" v-model="form.supplier_id">
                          <template v-slot:option="option">
                            <div class="row">
                              <div class="col-md-5 p-1 m-0">
                                {{ option.code }}
                          ...
                          <template #search="{ attributes, events }">
                            <input class="vs__search" :required="!form.supplier_id" v-bind="attributes" v-on="events" />
                          </template>
                          <li slot-scope="{ search }" slot="list-footer" class="d-flex justify-content-between"
                            v-if="lookup_suppliers.data.length || search">
                            <span v-if="lookup_suppliers.current_page > 1" @click="onGetSupplier(search, false)" class="
                                flex-fill
                                bg-primary
                                text-white text-center
                              " style="cursor: pointer">Sebelumnya</span>
                            <span v-if="lookup_suppliers.last_page >
                              lookup_suppliers.current_page
                              " @click="onGetSupplier(search, true)" class="
                                flex-fill
                                bg-primary
                                text-white text-center
                              " style="cursor: pointer">Selanjutnya</span>
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-sm-10 align-self-center ml-0 pl-0">
                        <input class="form-control" disabled :value="form.supplier_id
                  ...
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-sm-10 align-self-center">
                        <select class="form-control form-control-sm" v-model="form.discount_type"
              ...
              <div class="d-flex flex-row">
                                  ...
                                  <div class="col-sm-6">
                                    <div class="form-group">
                                                    <div class="row">
                                                    <div class="col-sm-2 align-self-center mr-0 pr-0">
                                                        <label for="due_date">Supplier D/O No</label>
                                                    </div>
                                                    <div class="col-sm-10 align-self-center ml-0 pl-0">
                                                      <input type="text" v-model="form.no_pengiriman" class="form-control">
              ...
              <div class="clearfix mt-4">
                <span class="btn btn-primary float-right" @click="addDetail" style="cursor: pointer">
              ...
              <div class="table-responsive table-striped">
                <table class="table table-sm mt-3">
                  <tr>
                    <td class="text-left table-transaction-header" style="width: 8%">
                      Kode
                    </td>
                    <td class="text-left table-transaction-header" style="width: 30%">
                      Product
                    </td>
                    <td class="text-left table-transaction-header"
                                          style="width:10%">Grade</td>
                    <td class="text-left table-transaction-header" style="width: 5%">
                      Unit
                    </td>
                    <td class="text-left table-transaction-header" style="width: 5%">
                      Qty
                    ...
                    <!-- <td class="text-left table-transaction-header" style="width: 6%">
                      Discount
                    ...
                    <td class="text-left table-transaction-header" style="width: 1%">
                      Opsi
                    </td>
                  </tr>

                  <tr v-for="(item, index) in form.purchaseing_details" :key="index">
                    <td class="table-transaction-row">
                      <input type="text" class="form-control" :value="item.product_id ? item.product_id.code : '-'"
                        disabled />
                    </td>

                    <td class="table-transaction-row">
                      <v-select label="name" :loading="isLoadingGetProduct" :options="lookup_products.data"
                        :filterable="false" @search="onGetProduct" @input="onSetProduct(index)" v-model="item.product_id">
                        <template v-slot:option="option">
                          <div class="row">
                            <div class="col-md-5 p-1 m-0">
                              {{ option.name }}
                        ...
                        <li slot-scope="{ search }" slot="list-footer" class="d-flex justify-content-between"
                          ...
                          <span v-if="lookup_products.current_page > 1" @click="onGetProduct(search, false)"
                            class="flex-fill bg-primary text-white text-center" style="cursor: pointer">Sebelumnya</span>
                          <span v-if="lookup_products.last_page >
                            lookup_products.current_page
                            " @click="onGetProduct(search, true)" class="flex-fill bg-primary text-white text-center"
                            style="cursor: pointer">Selanjutnya</span>
                        </li>
                      </v-select>
                    </td>
                    ...
                    <td class="table-transaction-row">
                      <input type="text" class="form-control" :value="item.product_id ? item.product_id.purchase_unit : '-'
                        " disabled />
                    </td>
                    <td class="table-transaction-row">
                      <money v-model="item.quantity" class="form-control" @keydown.native="
                        $event.key === '-' ? $event.preventDefault() : null
                        " @keyup.native="itemChange(index)" />
                    </td>
                    <td class="table-transaction-row">
                      <money v-model="item.price" class="form-control" @keydown.native="
                        $event.key === '-' ? $event.preventDefault() : null
                        " @keyup.native="itemChange(index)" />
                    </td>
                    <!-- <td class="table-transaction-row">
                      <money v-model="item.discount" class="form-control" @keydown.native="
                        $event.key === '-' ? $event.preventDefault() : null
                        " @keyup.native="itemChange(index)" />
                    </td>
                    <td class="table-transaction-row">
                      <money v-model="item.tax" class="form-control" @keydown.native="
                        $event.key === '-' ? $event.preventDefault() : null
                        " @keyup.native="itemChange(index)" />
                    </td> -->
                    <td class="table-transaction-row">
                      <money v-model="item.amount" class="form-control" @keydown.native="
                        $event.key === '-' ? $event.preventDefault() : null
                        " />
                    </td>
                    <td class="text-center table-transaction-row">
                      <i class="fas fa-trash" style="cursor: pointer" @click="deleteDetail(index)"></i>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td colspan="3" class="text-left border-top table-success">
                      <input class="form-control form-control-sm" v-model="form.description" aria-placeholder="Keterangan"
                        placeholder="Keterangan ...." />
                    </td>
                    <td colspan="2" class="text-right pt-3">Total</td>
                    <td colspan="2">
                      <money v-model="form.total" class="form-control" @keydown.native="
                        $event.key === '-' ? $event.preventDefault() : null
                        " />
                    </td>
                  </tr>
                  ...
                  <!-- <tr>
                    ...
                    <td colspan="2">
                      <money v-model="form.discount" class="form-control" @keydown.native="
                        $event.key === '-' ? $event.preventDefault() : null
                  ...
                  <tr v-if="form.discount > 0.0">
                    ...
                    <td colspan="2">
                      <money v-model="form.total_discount_nominal" class="form-control" @keydown.native="
                        $event.key === '-' ? $event.preventDefault() : null
                        " disabled />
                    </td>
                  </tr> -->
                  ...
                  <tr>
                    <td colspan="5" class="text-right pt-3">Grand Total</td>
                    <td colspan="2">
                      <money v-model="form.grand_total" class="form-control" @keydown.native="
                        $event.key === '-' ? $event.preventDefault() : null
                        " />
                    </td>
                  </tr>
                  ...
                  <!-- <tr v-if="form.po_supplier_id">
                    ...
                    <td colspan="2">
                      <money class="form-control" v-model="form.dp" @keyup.native="checkValidDp" />
                    </td>
                  </tr> -->
                  ...
                  <tr v-if="form.dp > 0.00">
                    ...
                    <td colspan="2">
                      <money class="form-control" v-model="form.grand_total_and_dp" disabled />
                    </td>
                  </tr>
                </table>
              </div>

              <button class="btn btn-primary" @click="validate().then(onSubmit(invalid))" type="button">
  ...
  methods: {
    ...
    onSubmit(isInvalid) {
      ...
      if (!this.form.purchaseing_details.length) {
        this.$toaster.error("Detail Penerimaan Masih Kosong");
        return;
      }
      ...
      this.$axios({
        ...
        .then((res) => {
          this.$toaster.success(
            "Berhasil " + (this.isEditable ? "Update" : "Tambah") + " Penerimaan barang"
          );
