              ...
              <div class="col-12">
                ...
                <div class="row">
                  <div class="col-3 p-2"
                    ...
                    @click="selectedReport(item.condition,item.url, item.value)">
                    <div class="row">
              ...
              <div class="col-12 mt-3 p-4"
                ...
                <div class="table-responsive">
                  <table class="table table-striped table-sm vld-parent table-hover"
                    ref="formContainer" v-if="selected_tab == '0' || selected_tab == '1'">
                    <thead>
                      <tr>         
                        ...
                        <th class="text-center" style="width: 5%" v-if="selected_tab == '0'">                    
                          Bypass
                        </th>
                      </tr>
                    </thead>
                    <tbody>
                      ...
                      <tr v-for="(item, index) in form.permintaan_pembelian" :key="index">
                      ...
                      <td class="table-transaction-row">
                        ...
                        <td class="table-transaction-row">
                            {{ item.permintaan_user ? item.permintaan_user.fullname : "-" }}
                        </td>
                        ...
                        <td class="table-transaction-row">
                         ...
                         <td class="table-transaction-row" v-if="selected_tab == '0'">
                            {{ item.keterangan ?? "-" }}
                          </td>

                          <td class="table-transaction-row" v-if="selected_tab == '1'">
                              {{ item.notes ?? "-" }}
                            </td>
                        
                          <td class="table-transaction-row text-center" v-if="selected_tab == '0'" >
                             <button class="btn btn-sm"
                              @click="onBypass(item.id)"
                              >
                   ...
                   <table class="table table-striped table-sm vld-parent table-hover"
                      ref="formContainer" v-if="selected_tab == '2'">
                      <thead>
                        <tr>         
...
export default {  
  ...
  methods : {
    ...
    async onChangeType2() {
      ...
      this.form.pembelian = this.lookup_custom2.map(
        (item) => {
          return {
            ...item,
          };
    ...
    async onChangeType(value) {
      ...
      this.form.permintaan_pembelian = this.lookup_custom2.map(
        (item) => {
          return {
            ...item,
