            ...
            <div class="modal-body">
              <div class="row">
                  <div class="col-md-6">                  
                    <div class="form-group">
                      <label for="code">Kode Pembelian</label>
              ...
              <div class="row">
                <div class="col-md-6 form-group">
                  ...
                  <div>
                    {{ parameters.form.supplier ? parameters.form.supplier.name || '-' : '-'}}                    
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-4 form-group">
                  ...
                  <div>{{ parameters.form.debt | formatPrice }}</div>
                </div>
                <div class="col-md-4 form-group">
                  <label for="paid">Dibayar</label>
                  <div>{{ ( parseFloat(parameters.form.grand_total) - parseFloat(parameters.form.debt) ) | formatPrice }}</div>
                </div>
              </div>          
            </div>            
        </div>
