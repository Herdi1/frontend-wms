              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="purchaseing_id">Pembelian</label>
                    <input type="text"
                      class="form-control"
                      :value="parameters.form.purchaseing_id ? parameters.form.purchaseing_id.code : '-'"
                      disabled/>
                  </div>
                </div>      
              </div>            
                ...
                <div class="row">        
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text"
                        class="form-control"
                        :value="parameters.form.purchaseing_id ? (parameters.form.purchaseing_id.supplier ? parameters.form.purchaseing_id.supplier.name : '-') : '-'"
                        disabled=/>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <span v-if="parameters.form.purchaseing_id">
                        <money class="form-control"          
                          v-model="parameters.form.purchaseing_id.grand_total"
                          disabled
                        />        
                      </span>
                      <span v-else>
                ...
                <div class="form-group" >
                  ...
                  <span v-if="parameters.form.purchaseing_id">
                    <money class="form-control"          
                      v-model="parameters.form.purchaseing_id.debt"
                      disabled
                    />                                                
                  </span>
                  <span v-else>
                ...
                <div class="form-group"
                  ...
                  <label for="rest_of_debt">Sisa Hutang</label>
                   <money class="form-control"          
                      v-model="parameters.form.rest_of_debt"
                   />          
                </div>
...
export default {  
  ...
  data() {
    return {     
      ...
      parameters : {
        url : 'purchaseing_module/debt_payment',
        form : {
         code : '',      
         purchaseing_id : '',        
         chart_of_account_id : '',
  ...
  methods: {    
      ...
      let parameters = {
        ...
        form : {
          ...
          chart_of_account_id : typeof this.parameters.form.chart_of_account_id == 'object'
            ...
            : '',
          purchaseing_id : typeof this.parameters.form.purchaseing_id == 'object'
            ? this.parameters.form.purchaseing_id.id 
            : '',         
        }
      }
    ...
    changeAmount(){
      if(this.parameters.form.purchaseing_id){
        if(this.parameters.form.purchaseing_id.debt < this.parameters.form.amount){
          this.parameters.form.amount = this.parameters.form.purchaseing_id.debt;
        }

        this.parameters.form.rest_of_debt = parseFloat(this.parameters.form.purchaseing_id.debt) - parseFloat(this.parameters.form.amount);
      }        
    },
    ...
    async onSearchChartOfAccount() {
      if (!this.isLoadingGetChartOfAccount) {
        ...
        await this.lookUp({
          url: "purchaseing_module/debt_payment/get-chart-of-account",
