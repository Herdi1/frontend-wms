            ...
            <div class="receipt-main">
              ...
              <div class="row mt-2">
                <div class="col-md-6">
                  ...
                  <h5 class="mt-1">Sales </h5>
                  <span v-if="parameters.form.customer">
                    {{ parameters.form.customer.seller ? parameters.form.customer.seller.name || '-' : '-' }}
                  </span>
                  <span v-else>
                    -
                  </span>
                ...
                <div class="col-md-6 float-right ">
                  <div class="receipt-right text-right">
                    ...
                    <p><b>No Penawaran :</b> {{ parameters.form.quotation ? parameters.form.quotation.code : '-' }}</p>
              ...
              <div>
                <table class="table table-striped table-sm vld-parent">
                  ...
                  <tbody>
                    <tr v-for="item in parameters.form.po_customer_details" :key="item.id">
                    ...
                    <tr v-if="!parameters.form.po_customer_details.length">
