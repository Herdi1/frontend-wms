                ...
                <table class="table table-striped table-sm vld-parent table-hover"
                  ...
                  <tbody>
                    <tr :class="{'table-active': ActiveRow == i }" v-for="(item,i) in data" :key="i"  @click="onRowSelected(i)">
                      ...
                      <td>{{ item.date }}</td>
                      <td>
                        {{ item.po_customer ? item.po_customer.customer.name : '-' }}
                        ...
                        <span class="row m-0 p-0">
                          ...
                          <div class="col m-0 p-0">
                            ...
                            >
                               {{ item.po_customer ? item.po_customer.code : '-'}}  
                            </div>
                          </div>
                        </span>
                      ...
                      <td class="text-center">
                        <div class="btn-group border border-success">                 
                          ...
                          <!-- <button class="btn btn-sm" 
                            ...
                            v-if="
                              !item.deleted_at && 
                              item.material_requirements_count == 0 && 
                              item.productions_count == 0 &&
                              getRoles.update"
                              >
                            <i class="fas fa-pen text-warning"></i>
                          </button>
...
export default {
  ...
  computed : {
    ...
    getRoles(){
      if(!this.user.parent_id){
        ...
        let main_role = this.user.group_role.roles.find(item => item.name == "work_order");
  ...
  methods : {
    ...
    onFormShow(){    
      this.$router.push("/marketing/work_order/add");
    },

    onEdit(id){
      this.$router.push("/marketing/work_order/"+id);
    },
    ...
    onPrintDetail(item){
      ...
      window.open(process.env.API_URL + "/marketing/work_order/get-print-detail/" + item.id + "?token="+token, '_blank');    
    },
