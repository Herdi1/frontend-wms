                ...
                <table class="table table-striped table-sm vld-parent table-hover"
                  ...
                  <thead>
                    <tr>         
                      ...
                      <th>Pelanggan</th>
                      <th>Deskripsi</th>
                      <th @click="onSort('progress',parameters.params.sort == 'asc' ? 'desc' : 'asc')"
                        class="cursor-pointer">
                        <div class="d-flex flex-row justify-content-between align-items-baseline">
                          <div>Progress</div>
                          <div>
                            <i class="fas fa-caret-up"
                              :class="parameters.params.order == 'progress' && parameters.params.sort == 'asc' ? '' : 'light-gray'"></i>
                            <i class="fas fa-caret-down"
                              :class="parameters.params.order == 'progress' && parameters.params.sort == 'desc' ? '' : 'light-gray'"></i>
                          </div>
                        </div>
                      </th>                                      
                  ...
                  <tbody>
                    <tr :class="{'table-active': ActiveRow == i }" v-for="(item,i) in data" :key="i"  @click="onRowSelected(i)">
                      ...
                      <td> 
                        <span v-if="item.progress == 'Follow Up'"
                          class="badge badge-warning">
                          Follow Up
                        </span>
                        <span v-else-if="item.progress == 'Reject'"
                          class="badge badge-danger">
                          Reject
                        </span>
                        <span v-else-if="item.progress == 'Order'"
                          class="badge badge-success">
                          Order
                        </span>
                        <sapn v-else-if="item.progress == 'Quotation'" 
  ...
  computed : {
    ...
    getRoles(){
      if(!this.user.parent_id){
        ...
        let main_role = this.user.group_role.roles.find(item => item.name == "marketing_activity");
