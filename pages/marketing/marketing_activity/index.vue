                ...
                >
                        ...
                        >
                          ...
                          <div>
                            <i
                              class="fas fa-caret-up"
                              :class="
                                parameters.params.order == 'progress' &&
                                parameters.params.sort == 'asc'
                                  ? ''
                                  : 'light-gray'
                              "
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <td>
                        <span
                          v-if="item.progress == 'Follow Up'"
                          class="badge badge-warning"
                        >
                          Follow Up
                        </span>
                        <span
                          v-else-if="item.progress == 'Reject'"
                          class="badge badge-danger"
                        >
                          Reject
                        </span>
                        <span
                          v-else-if="item.progress == 'Order'"
                          class="badge badge-success"
                        >
                          Order
                        </span>
                        <sapn
                          v-else-if="item.progress == 'Quotation'"
                          class="badge badge-primary"
                        >
                          Quotation
                        </sapn>
                        <span class="badge badge-info" v-else> Prospect </span>
                      </td>
    ...
    getRoles() {
      if (!this.user.parent_id) {
        ...
        let main_role = this.user.group_role.roles.find(
          (item) => item.name == "marketing_activity"
        );
