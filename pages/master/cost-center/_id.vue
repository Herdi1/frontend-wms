        ...
        >
          <div class="form-group">
            <input-form
              ...
              type="text"
              name="kode_cost_center"
              :required="true"
              v-model="parameters.form.kode_cost_center"
            />
          </div>
          <div class="form-group">
            <input-form
              ...
              :required="true"
              v-model="parameters.form.nama_cost_center"
            />
          </div>
          <ValidationProvider
            ref="inputProvider"
...
export default {
  ...
  async created() {
    try {
      if (this.isEditable) {
        let res = await this.$axios.get(`master/cost-center/${this.id}`);
    ...
    async onSubmit(isInvalid) {
      ...
      let parameters = {
        ...
        form: {
          ...
          id: this.parameters.form.cost_center_id
            ? this.parameters.form.cost_center_id
            : "",
        },
      };
