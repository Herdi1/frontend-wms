          ...
          <table ref="formContainer" class="border border-gray-300">
            <thead>
              <tr class="uppercase">
                  ...
                  <div class="flex justify-between align-baseline">
                    ...
                    <div>
                      <i
                        ...
                        :class="
                          parameters.params.order == 'nama_status' &&
                ...
                <th class="border border-gray-300">Turunan Status</th>
...
export default {
    ...
    return {
      ...
      parameters: {
        ...
        params: {
          soft_deleted: "",
          search: "",
          order: "master_statusproseskirim_id",
          sort: "desc",
          all: "",
          per_page: 10,
          page: 1,
    ...
    getRoles() {
      if (this.user.is_superadmin == 1) {
        ...
        let main_role = this.user.role.menus.find(
          (item) => item.rute == "master-status-proses-kirim"
        );
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/master/master-status-proses-kirim/add");
    },

    onEdit(item) {
      this.$router.push(
        "/master/master-status-proses-kirim/" + item.master_statusproseskirim_id
      );
    },
        ...
        callback: async (confirm) => {
          if (confirm) {
            ...
            await this.deleteData({
              ...
              id: item.master_statusproseskirim_id,
