            ...
            <div class="modal-body"> 
                  <div class="form-group">
                        ...
                        <v-select
                          ...
                          @search="onGetProces"
                          @input="onSetProces"
                          v-model="parameters.form.grade_kategori_id"
...
export default {  
  ...
  methods: {    
    ...
    async onSubmit(isInvalid){       
      ...
      let parameters = {
        ...
        form: {
          ...
          grade_kategori_id: typeof this.parameters.form.grade_kategori_id == 'object'
            ? this.parameters.form.grade_kategori_id.id
            : '',
        }
      };
      if(this.isEditable){
    ...
    onSetProces(item) {
      if (!item) {
        this.parameters.form.grade_kategori_id = '';
      }
    }
  },
};
