              ...
              <tbody>
                <tr v-for="(item, i) in data" :key="i">
                  ...
                  <td class="border border-gray-300">
                    {{ item.kode_tipe_pajak }}
                  </td>
                  <td class="border border-gray-300">
                    {{ item.nama_tipe_pajak }}
                  </td>
                  <td class="border border-gray-300">{{ item.nilai }} %</td>
...
export default {
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/master/tipe-ppn/add");
    },

    onEdit(item) {
      this.$router.push("/master/tipe-ppn/" + item.tipe_ppn_id);
    },
