          ...
          <table ref="formContainer" class="border border-gray-300">
              ...
              <tr class="uppercase">
                ...
                >
                  <div class="flex justify-between align-baseline">
                    <div>Nama Tipe SIM</div>
                    <div>
                      <i
                        class="fas fa-caret-up"
                        :class="
                          parameters.params.order == 'nama_tipe_sim' &&
            ...
            <tbody>
              <tr v-for="(item, i) in data" :key="i">
                ...
                <td class="border border-gray-300">{{ item.nama_tipe_sim }}</td>
                <td class="border border-gray-300">{{ item.kode_tipe_sim }}</td>
...
export default {
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/master/tipe-sim/add");
    },

    onEdit(item) {
      this.$router.push("/master/tipe-sim/" + item.tipe_sim_id);
    },
