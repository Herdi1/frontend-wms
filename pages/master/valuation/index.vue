    ...
    <div class="gap-5">
      <div class="w-full bg-white dark:bg-slate-800 rounded-md p-2 px-4">
        ...
        <div class="overflow-x-auto">
          <table
            class="mb-5 border border-collapse border-gray-300"
            ref="formContainer"
          >
            <thead>
              <tr class="uppercase">
                ...
                <th class="border border-gray-300">Kode Valuation</th>
                <th
                  @click="
                    onSort(
                      'nama_valuation',
                  ...
                  <div class="flex justify-between align-baseline">
                    ...
                    <div>
                      <i
                        ...
                        :class="
                          parameters.params.order == 'nama_valuation' &&
            ...
            <tbody>
              <tr v-for="(item, i) in data" :key="i">
                ...
                <td class="border border-gray-300">{{ item.group }}</td>
                <td class="border border-gray-300 place-items-center">
                  <small-delete-button
...
export default {
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/master/valuation/add");
    },

    onEdit(item) {
      this.$router.push("/master/valuation/" + item.valuation_id);
    },
