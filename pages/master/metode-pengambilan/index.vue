          ...
          <table ref="formContainer" class="border border-gray-300">
            <thead>
              <tr class="uppercase">
                ...
                <th class="border border-gray-300">Kode Metode Pengambilan</th>
                <th
                  @click="
                    onSort(
                      'metode_pengambilan',
            ...
            <tbody>
              <tr v-for="(item, i) in data" :key="i">
                ...
                <td class="border border-gray-300">{{ item.kode_metode }}</td>
                <td class="border border-gray-300">{{ item.nama_metode }}</td>
...
export default {
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/master/metode-pengambilan/add");
    },

    onEdit(item) {
      this.$router.push(
        "/master/metode-pengambilan/" + item.metode_pengambilan_id
      );
    },
