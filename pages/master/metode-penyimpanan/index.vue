              ...
              <tbody>
                <tr v-for="(item, i) in data" :key="i">
                  ...
                  <td class="border border-gray-300">
                    {{ item.kode_metode_penyimpanan }}
                  </td>
                  <td class="border border-gray-300">
                    {{ item.nama_metode_penyimpanan }}
                  </td>
...
export default {
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/master/metode-penyimpanan/add");
    },

    onEdit(item) {
      this.$router.push(
        "/master/metode-penyimpanan/" + item.metode_penyimpanan_id
      );
    },
