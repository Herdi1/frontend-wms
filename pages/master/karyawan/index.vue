                ...
                >
                  <thead>
                    <tr>
                      ...
                      <th class="text-center" style="width: 10%">Regu</th>
                      <th class="text-center" style="width: 10%">Man Power</th>
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <td>
                        {{
                          item.man_power_type ? item.man_power_type.name : "-"
                        }}
                      </td>
