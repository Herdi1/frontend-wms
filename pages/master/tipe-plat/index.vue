                ...
                <tr class="text-base uppercase">
                  ...
                  >
                    <div class="flex justify-between items-baseline">
                      <div>Kode Tipe Plat</div>
                      <div>
                        <i
                          class="fas fa-caret-up"
                          :class="
                            parameters.params.order == 'kode_tipe_plat' &&
                  ...
                  >
                    <div class="flex justify-between items-baseline">
                      <div>Nama Tipe Plat</div>
                      <div>
                        <i
                          class="fas fa-caret-up"
                          :class="
                            parameters.params.order == 'nama_tipe_plat' &&
                            parameters.params.sort == 'asc'
                              ? ''
                              : 'light-gray'
                          "
...
export default {
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/master/tipe-plat/add");
    },

    onEdit(item) {
      this.$router.push("/master/tipe-plat/" + item.tipe_plat_id);
    },
