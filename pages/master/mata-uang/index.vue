            ...
            <table class="mb-5 border border-gray-300" ref="formContainer">
              <thead>
                <tr class="text-base uppercase">
                    ...
                    <div class="flex justify-between items-baseline">
                      ...
                      <div>
                        <i
                          class="fas fa-caret-up"
                          :class="
                            parameters.params.order == 'nama_mata_uang' &&
                            parameters.params.sort == 'asc'
                              ? ''
                              : 'light-gray'
                          "
                  ...
                  <th class="border border-gray-300">Kurs</th>
              ...
              <tbody>
                <tr v-for="(item, i) in data" :key="i">
                  ...
                  <td class="border border-gray-300">{{ item.kurs }}</td>
...
export default {
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/master/mata-uang/add");
    },

    onEdit(item) {
      this.$router.push("/master/mata-uang/" + item.mata_uang_id);
    },
