            ...
            <table class="mb-5 border border-gray-300" ref="formContainer">
                    ...
                    <div class="flex justify-between items-baseline">
                      ...
                      <div>
                        <i
                          ...
                          :class="
                            parameters.params.order == 'group_item_id_induk' &&
                    ...
                    <div class="flex justify-between items-baseline">
                      ...
                      <div>
                        <i
                          class="fas fa-caret-up"
                          :class="
                            parameters.params.order == 'nama_group_item' &&
                            parameters.params.sort == 'asc'
                              ? ''
                              : 'light-gray'
                          "
              ...
              <tbody>
                <tr v-for="(item, i) in data" :key="i">
                  ...
                  <td class="border border-gray-300">
                    {{ item.kode_group_item }}
                  </td>
                  <td class="border border-gray-300">
                    {{ item.nama_group_item }}
                  </td>
                  <td class="border border-gray-300">
                    Level {{ item.status }}
                  </td>
...
export default {
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/master/group-item/add");
    },

    onEdit(item) {
      this.$router.push("/master/group-item/" + item.group_item_id);
    },
