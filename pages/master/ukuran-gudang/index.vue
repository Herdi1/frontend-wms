            ...
            <table class="mb-5 border border-gray-300" ref="formContainer">
              <thead>
                <tr class="text-base uppercase">
                  ...
                  <th
                    ...
                    "
                    class="cursor-pointer w-[20%] border border-gray-300"
                  >
                    <div class="flex justify-between items-baseline">
                      ...
                      <div>
                        <i
                          ...
                          :class="
                            parameters.params.order == 'kode_ukuran' &&
                  ...
                  <th class="w-[25%] border border-gray-300">Nama Ukuran</th>
              ...
              <tbody>
                <tr v-for="(item, i) in data" :key="i">
                  ...
                  <td class="border border-gray-300">{{ item.kode_ukuran }}</td>
                  <td class="border border-gray-300">{{ item.nama_ukuran }}</td>
...
export default {
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/master/ukuran-gudang/add");
    },

    onEdit(item) {
      this.$router.push("/master/ukuran-gudang/" + item.ukuran_gudang_id);
    },
