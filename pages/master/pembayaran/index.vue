            ...
            <table class="mb-5 border border-gray-300" ref="formContainer">
              <thead>
                <tr class="text-base uppercase">
                    ...
                    <div class="flex justify-between items-baseline">
                      ...
                      <div>
                        <i
                          ...
                          :class="
                            parameters.params.order == 'kode_pembayaran' &&
                  ...
                  >
                    <div class="flex justify-between items-baseline">
                      <div>Nama Pembayaran</div>
                      <div>
                        <i
                          class="fas fa-caret-up"
                          :class="
                            parameters.params.order == 'nama_pembayaran' &&
                            parameters.params.sort == 'asc'
                              ? ''
                              : 'light-gray'
                          "
...
export default {
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/master/pembayaran/add");
    },

    onEdit(item) {
      this.$router.push("/master/pembayaran/" + item.pembayaran_id);
    },
