        ...
        <div class="col-12 col-md-12">
          <div class="card">
            <div class="card-body">
              ...
              <div v-if="parameters.form.checkboxs.length" clas="p-1">
              ...
              <div class="table-responsive">
                <table class="table table-striped table-sm vld-parent table-hover"
                  ...
                  <thead>
                    <tr>         
                      ...
                      <th @click="onSort('code',parameters.params.sort == 'asc' ? 'desc' : 'asc')"
                        class="cursor-pointer" style="width:10%">
                  ...
                  <tr
                      ...
                      <td>
                        <span v-if="item.type === 'GROUP'"> {{ 'G-'+item.code }}</span>
                        <span v-if="item.type === 'PROPERTIE'"> {{ 'P-'+item.code }}</span>
                        <span v-if="item.type === 'VALUE'">{{item.code }}</span></td>                        
                      <td>{{ item.name }}</td>      
                      <td><b>{{ item.type }}</b></td>
                      <td><b>{{ item.parent ? item.parent.name : '-' }}</b></td>
...
export default {
  ...
  computed : {
    ...
    getRoles(){
      if(!this.user.parent_id){
        ...
        let main_role = this.user.group_role.roles.find(item => item.name == "product_spesification");
  ...
  methods : {
    ...
    onFormShow(){
      this.$refs["form-input"].parameters.form_group = {
        code : '',
        name : '',
        type : 'GROUP',
      };

      this.$refs["form-input"].parameters.form_propertie = {
        code : '',
        name : '',
        type : 'PROPERTIE',
        parent_id : ''
      ...
      this.$refs["form-input"].parameters.form_value = {
        code : '',
        name : '',
        type : 'VALUE',
        parent_id : ''
    ...
    onEdit(item){
      ...
      switch (item.type) {
        case "GROUP":
          ...
          this.$refs["form-input"].editType = 'GROUP';
        break;
        case "PROPERTIE":
          this.$refs["form-input"].parameters.form_propertie = {
            id  : item.id,  
          ...
          this.$refs["form-input"].editType = 'PROPERTIE';
        break;
        case "VALUE":                
          this.$refs["form-input"].parameters.form_value = {
            id  : item.id,  
          ...
          this.$refs["form-input"].editType = 'VALUE';
        break;
      }
