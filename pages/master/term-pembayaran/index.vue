          ...
          <table ref="formContainer" class="border border-gray-300">
            <thead>
              <tr class="uppercase">
                ...
                <th class="border border-gray-300">Kode Term Pembayaran</th>

                <th class="border border-gray-300">Keterangan</th>
                <th class="border border-gray-300">Durasi (Hari)</th>
            ...
            <tbody>
              <tr v-for="(item, i) in data" :key="i">
                ...
                <td class="border border-gray-300">
                  {{ item.nama_term_pembayaran }}
                </td>
                <td class="border border-gray-300">
                  {{ item.kode_term_pembayaran }}
                </td>
                <td class="border border-gray-300">{{ item.keterangan }}</td>
                <td class="border border-gray-300">{{ item.durasi }}</td>
