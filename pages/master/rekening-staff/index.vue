          ...
          <table ref="formContainer">
                  ...
                  <div class="flex justify-between align-baseline">
                    ...
                    <div>
                      <i
                        ...
                        :class="
                          parameters.params.order == 'nama_pemilik' &&
            ...
            <tbody>
              <tr v-for="(item, i) in data" :key="i">
                ...
                <td>{{ item.staff ? item.staff.nama_staff : "-" }}</td>
                <td>{{ item.no_rekening }}</td>
                <td>{{ item.bank ? item.bank.nama_bank : "-" }}</td>
                <td>
                  {{
                    item.status_aktif === "1"
                      ? "Aktif"
...
export default {
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/master/rekening-staff/add");
    },

    onEdit(item) {
      this.$router.push(`/master/rekening-staff/${item.rekening_staff_id}`);
    },
