            ...
            <table class="mb-5" ref="formContainer">
              <thead>
                <tr class="text-base uppercase">
                  ...
                  >
                    <div class="flex justify-between items-baseline">
                      <div>Nama Group Item</div>
                      <div>
                        <i
                          class="fas fa-caret-up"
                          :class="
                            parameters.params.order == 'nama_group_gudang' &&
                            parameters.params.sort == 'asc'
                              ? ''
                              : 'light-gray'
                          "
              ...
              <tbody>
                <tr v-for="(item, i) in data" :key="i">
                  ...
                  <td>
                    {{
                      item.group_gudang_induk
                        ? item.group_gudang_induk.nama_group_gudang
                        : "Tidak Memiliki Group Induk"
                    }}
                  </td>
                  <td>{{ item.nama_group_gudang }}</td>
                  <td>{{ item.kode_group_gudang }}</td>
...
export default {
  ...
  methods: {
    ...
    onFormShow() {
      ...
      // });
      this.$router.push("/master/group-gudang/add");
    },
    ...
    onEdit(item) {
      ...
      //   this.$refs.formInput?.$refs?.formValidate?.reset();
      // });
      this.$router.push("/master/group-gudang/" + item.group_gudang_id);
    },
