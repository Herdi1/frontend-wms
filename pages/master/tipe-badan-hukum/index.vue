          ...
          <table ref="formContainer" class="border border-gray-300">
            <thead>
              <tr class="uppercase">
                ...
                <th class="border border-gray-300">Kode Badan Hukum</th>
                <th
                  @click="
                    onSort(
            ...
            <tbody>
              <tr v-for="(item, i) in data" :key="i">
                ...
                <td class="border border-gray-300">
                  {{ item.kode_tipe_badan_hukum }}
                </td>
                <td class="border border-gray-300">
                  {{ item.nama_tipe_badan_hukum }}
                </td>
...
export default {
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/master/tipe-badan-hukum/add");
    },

    onEdit(item) {
      this.$router.push("/master/tipe-badan-hukum/" + item.tipe_badan_hukum_id);
    },
