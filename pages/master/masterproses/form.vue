            ...
            <div class="modal-body"> 
                  <div class="form-group">
                        ...
                        <select
                          ...
                          <option value="1">Process Activity</option> 
                          <option value="2">Process Output</option>                      
                        </select>                  
                  </div>   
                  
                  <div class="form-group">
                        <label for="seller_id">Induk Proses</label>
                        <v-select
                          label="name"
                          ...
                          @search="onGetProces"
                          @input="onSetProces"
                          v-model="parameters.form.proces_induk_id"
...
export default {  
  ...
  methods: {    
    ...
    async onSubmit(isInvalid){       
      ...
      let parameters = {
        ...
        form: {
          ...
          proces_induk_id: typeof this.parameters.form.proces_induk_id == 'object'
            ? this.parameters.form.proces_induk_id.id
            : '',
        }
      };
      if(this.isEditable){
    ...
    onSetProces(item) {
      if (!item) {
        this.parameters.form.proces_induk_id = '';
      }
    }
  },
};
