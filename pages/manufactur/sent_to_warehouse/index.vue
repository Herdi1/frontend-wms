                  ...
                  <tbody>
                    ...
                    >                    
                      ...
                      <td>
                        ...
                        Produksi : {{ item.production ? item.production.code : "-" }}
...
export default {
    ...
    getRoles() {
      if (!this.user.parent_id) {
        ...
        let main_role = this.user.group_role.roles.find(
          (item) => item.name == "sent_to_warehouse"
        );
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/manufactur/sent_to_warehouse/add");
    },

    onEdit(id) {
      this.$router.push("/manufactur/sent_to_warehouse/" + id);
    },
