...
export default {
    ...
    getRoles() {
      if (!this.user.parent_id) {
        ...
        let main_role = this.user.group_role.roles.find(
          (item) => item.name == "packinglist_mutation"
        );
  ...
  methods: {
    ...
    onEdit(id) {
      this.$router.push("/manufactur/packinglist/" + id);
    },
    ...
    closePackingList(item) {
      let url = "manufactur/packinglist/close-packing-list";
