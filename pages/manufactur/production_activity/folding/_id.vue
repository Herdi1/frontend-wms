              ...
              <ValidationObserver
                  ...
                  <form
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <!-- {{ form.ex_master_machine_id }} -->
                        <div class="row">
                          <div class="col-md-3">
                      <div class="form-group">
                          <label for="supplier_id">Ex Mesin</label>
                          </div>
                          </div>
                          <div class="col-md-9">
                          ...
                          <v-select
                            ...
                            @search="onGetExMesin"
                            @input="changeMesin"
                            v-model="form.ex_master_machine_id"
                          ...
                          >
                            ...
                            <template #search="{ attributes, events }">
                              <input
                                class="vs__search"
                                :required="!form.ex_master_machine_id"
                                v-bind="attributes"
                                v-on="events"
                              />
                            </template>
                      ...
                      />
                          ...
                          <select
                                    ...
                                    >
                                      <option value="">Pilih</option>
                                      <option
                                        v-for="item in lookup_suppliers.data"
                                        :key="item.id"
                                        :value="item.id"
                                      >
                                        {{ item.name }}
...
export default {
  ...
  data() {
    ...
    return {
      ...
      isStopSearchProductionDetail: false,
      isLoadingGetProductionDetail: false,
      production_detail_search: "",
  ...
  async mounted() {
    ...
    await this.lookUp({
      url: "master/masterdefect/get-defect",
      lookup: "suppliers",
      // query: "",
      query: "?order=id&sort=asc",
  ...
  methods: {
    ...
    changeMesin() {
      let beam = '';
        if (this.form.ex_master_machine_id) {
          this.form.production_detail_id = this.form.ex_master_machine_id.production_planning_terakhir ? this.form.ex_master_machine_id.production_planning_terakhir.production_detail : '';
          if (this.form.ex_master_machine_id.production_planning_terakhir) {
            if (this.form.ex_master_machine_id.production_planning_terakhir.production_activity_loom) {
              // console.log("this.form.ex_master_machine_id.production_planning_terakhir.production_activity[0].master_beam");
              beam = this.form.ex_master_machine_id.production_planning_terakhir.production_activity_loom.master_beam;
            } else {
              beam = ''
              // console.log("gsgsl");
          ...
          this.form.master_beam_id = beam;
          this.countTotal();
          // this.form.master_beam_id = this.form.ex_master_machine_id.production_planning_terakhir.production_activity ?
          //   this.form.ex_master_machine_id.production_planning_terakhir.production_activity[0].master_beam ?
          //   this.form.ex_master_machine_id.production_planning_terakhir.production_activity[0].master_beam : '' : '';
        }
      },
    ...
    // async onChangeExMesin() {
    //   let parent_id = this.form.ex_master_machine_id.id;
    //   await this.getCode({
      ...
      if (!this.isLoadingGetPacking) {
        ...
        await this.lookUp({
          ...
          query:
            ...
            "&per_page=10&sort=asc&tanggal="+ moment().format("YYYY-MM-DD") +"&status=OPEN&jenis_produksi=FOLDING",
        });
      ...
      if (!this.isLoadingGetExMesin) {
        ...
        await this.lookUp({
          ...
          query:
            ...
            "&per_page=10&sort=asc&master_proces_id=16",
        });
      ...
      if (!this.isLoadingGetMesin) {
        ...
        await this.lookUp({
          ...
          query:
            ...
            "&per_page=10&sort=asc&master_proces_id=17",
        });
