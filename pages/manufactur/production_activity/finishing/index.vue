...
export default {
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/manufactur/production_activity/finishing/add");
    },

    onEdit(item) {
      this.$router.push("/manufactur/production_activity/finishing/" + item.id);
    },
