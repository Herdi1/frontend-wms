                ...
                <table
                  ...
                  <tbody>
                    <tr
                      ...
                      <td>{{ item.regu ? item.regu.code : '-' }}</td> 
                      <td>{{ item.speed }}</td>  
                      <td>{{ item.no_set }}</td>  
                        <td>{{ item.code }}</td>
                        <td>{{ item.production_detail.no_batch }}</td>  
                        <td>{{ item.production_detail.product ? item.production_detail.product.code  : '-'}}</td>                  
                        <td>{{ item.production_detail.product ? item.production_detail.product.name : '-' }}</td> 
                      <td></td>                  
                      <td>{{ item.master_beam ? item.master_beam.name : "-"}}</td>                  
...
export default {
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/manufactur/production_activity/warping/add");
    },

    onEdit(item) {
      this.$router.push("/manufactur/production_activity/warping/" + item.id);
    },
