  ...
  methods: {
    ...
    async onChangeMesin() {
      ...
      if (this.form.master_machine_id) {
        this.form.production_detail_id = this.form.master_machine_id.production_planning_terakhir ? this.form.master_machine_id.production_planning_terakhir.production_detail : '';
        this.form.master_beam_id = this.form.master_machine_id.production_planning_terakhir ? this.form.master_machine_id.production_planning_terakhir.master_beam : '';
      }
      // this.form.production_detail_id = this.form.master_machine_id.production_planning_terakhir ? this.form.master_machine_id.production_planning_terakhir.production_detail : '';
      // this.form.master_beam_id = this.form.master_machine_id.production_planning_terakhir ? this.form.master_machine_id.production_planning_terakhir.master_beam : '';
    },
      ...
      if (!this.isLoadingGetMesin) {
        ...
        await this.lookUp({
          ...
          query:
            ...
            "&per_page=10&sort=asc&master_proces_id=13",
        });
