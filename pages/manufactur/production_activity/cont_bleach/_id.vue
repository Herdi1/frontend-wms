              ...
              <ValidationObserver
                  ...
                  <form
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        >
                          ...
                          <div class="col-md-6">
                          <div class="form-group">
                          <label for="customer_id">Ex Start #</label>
                          <v-select
                            label="code"
                            :loading="isLoadingGetProductionPlanning"
                            :options="lookup_custom3.data"
                            :filterable="false"
                            @search="onGetProductionPlanning"
                            @input="onSetProduksi"
                          ...
                          >
                            ...
                            >
                              <a
                                ...
                                @click="onGetProductionPlanning(search, false)"
                                class="flex-fill bg-primary text-white text-center"
                                href="#"
                                >Sebelumnya</a
                              >
                              <a
                                v-if="lookup_custom3.last_page >
                                  ...
                                  "
                                @click="onGetProductionPlanning(search, true)"
                                class="flex-fill bg-primary text-white text-center"
                                href="#"
                                >Selanjutnya</a
                              >
                    ...
                    <div class="row">
                      <div class="col-md-12">
                     <div class="form-group">
                        <label for="purchase_price">Length (YARD)</label>
                        <!-- <money
                          v-model="form.length"
                          class="form-control"
                          @keydown.native="
...
export default {
  ...
  data() {
    ...
    return {
      ...
      isStopSearchProductionPlanning: false,
      isLoadingGetProductionPlanning: false,
      productionplanning_search: "",
      ...
      form: {
        ...
        end_time: moment().format("YYYY-MM-DD 00:00"),
        regu_id: '',
  ...
  async mounted() {
    ...
    await this.onSearchProductionPlanning();
  ...
  methods: {
    ...
    async onChangeMesin() {
      ...
      if (this.form.master_machine_id.production_planning) {
        speed = this.form.master_machine_id.production_planning.speed;
      }
 ...
 onGetProductionPlanning(search, isNext) {
      if (!search.length && typeof isNext === "function") return false;

      clearTimeout(this.isStopSearchProductionPlanning);

      this.isStopSearchProductionPlanning = setTimeout(() => {
        this.productionplanning_search = search;
        ...
        this.onSearchProductionPlanning();
      }, 600);
    },

    async onSearchProductionPlanning() {
      if (!this.isLoadingGetProductionPlanning) {
        this.isLoadingGetProductionPlanning = true;

        await this.lookUp({
          url: "manufactur/production_planning/get-planning",
          lookup: "custom3",
          query:
            "?search=" + this.productionplanning_search +
            "&page=" + this.lookup_custom3.current_page +
            "&per_page=10&sort=asc&master_proces_id=19",
        });

        this.isLoadingGetProductionPlanning = false;
      }
    },
      ...
      if (!this.isLoadingGetMesin) {
        ...
        await this.lookUp({
          ...
          query:
            ...
            "&per_page=10&sort=asc&master_proces_id="+this.form.parent_proces_id,
        });
