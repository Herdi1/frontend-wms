  ...
  methods: {
    ...
    onSetProduksi() {
      ...
      if (this.form.master_machine_id) {
          production = this.form.master_machine_id.production_planning_terakhir ? this.form.master_machine_id.production_planning_terakhir.production_detail : '';
        if (this.form.master_machine_id.production_planning_terakhir) {
          beam = this.form.master_machine_id.production_planning_terakhir.production_activity_loom ? this.form.master_machine_id.production_planning_terakhir.production_activity_loom.master_beam : '';
          this.countTotal();
        }
      }
