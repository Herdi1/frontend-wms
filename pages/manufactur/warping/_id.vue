                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      <div class="row" style="heigth:30px">
                        <div class="col-sm-2 align-self-center">
                          <label for="id">No Batch/ No Order</label>
                        </div>
                        <div class="col-sm-10 align-self-center">
                          <v-select
                            label="id"
...
export default {
  ...
  async created() {
    try {
      ...
      this.$router.push("/manufactur/warping");
    }
  },
  ...
  methods: {
    ...
    onSubmit(isInvalid) {
      ...
      let url = "manufactur/productionproses";
      ...
      this.$axios({
        ...
        .then((res) => {
          this.$toaster.success("Berhasil " + (this.isEditable ? "Update" : "Tambah") + " Rencana Proses Produksi" +res.data);

          if (!this.isEditable) {
            let param = this.form.production_detail_id;
            this.form = {
              ...this.default_form,
              production_detail_id : res.data.production_detail,
              production_details: [],
            };
            ...
            // this.form.production_detail_id = param;
