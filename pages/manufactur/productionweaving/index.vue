                ...
                >
                  <thead>
                    <tr>
                      ...
                      >
                        ...
                        >
                          <div style="width: 25%">No Beam</div>
                          <div>
                            <i
                      ...
                      <th style="width: 5%">Mesin Tenun</th>
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <td>
                        {{ item.master_machine_tenun.name }}
                      </td>
                      <td>{{ item.tanggal }}</td>
                      <!-- <td
...
export default {
  ...
  data() {
    return {
      ...
      parameters: {
        url: "manufactur/productionweaving",
        type: "pdf",
        params: {
          soft_deleted: "",
          search: "",
    ...
    getRoles() {
      if (!this.user.parent_id) {
        ...
        let main_role = this.user.group_role.roles.find(
          (item) => item.name == "productionweaving"
        );
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/manufactur/weaving/add");
    },

    onEdit(item) {
      this.$router.push("/manufactur/weaving/" + item.id);
    },
