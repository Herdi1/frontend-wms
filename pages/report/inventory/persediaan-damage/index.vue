      ...
      <div class="card-body">
        <div class="w-full mt-2 mb-3">
          ...
          >
            ...
            <div class="flex w-full m-1 pr-1">
              <label class="w-[50%]" for="region">Region </label>
              <v-select
                label="nama_wilayah"
  ...
  methods: {
    ...
    onPreview() {
      if (
        ...
        this.$toaster.error(
          "Mohon Pilih Gudang, Tipe Transaksi, Kategori, Periode Awal dan Akhir Terlebih Dahulu"
        );
        return;
      }

      if (
        this.parameters.params.type === "rasio_damage_pembelian_per_cabang" ||
        this.parameters.params.type === "rasio_damage_total_stok"
      ) {
        if (!this.parameters.form.wilayah_id) {
          this.$toaster.error("Mohon Pilih Wilayah Terlebih Dahulu ");
          return;
        }
      }
