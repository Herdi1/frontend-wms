                  ...
                  <tbody>
                    <tr v-for="(item, i) in data" :key="i">
                      ...
                      <td>
                        {{
                          (item.product
                            ? item.product.cost_of_products_sold
                            : 0) | formatPrice
                        }}
                      </td>
                      <td>{{ item.quantity }}</td>
                      <td>
                        {{
                          (parseFloat(item.quantity) *
                            (item.product
                              ? parseFloat(item.product.cost_of_products_sold)
                              : 0))
                            | formatPrice
                        }}
                      </td>
          ...
          <div class="form-group">
            ...
            >
              ...
              >
                ...
                <span
                  v-if="
                    lookup_warehouses.last_page > lookup_warehouses.current_page
                  "
...
export default {
  ...
  computed: {
    ...mapState("moduleApi", ["lookup_warehouses", "lookup_suppliers"]),
