      ...
      report_tabs : [        
        {
          ...
          sub_title : '  Menampilkan laporan progress produksi per hari',
          condition : 'production',
          url : process.env.API_URL + "/report/manufactur/get-produksi-harian"
        },
        {
          icon: 'hand-holding-usd',
          title: 'Laporan Progres Produksi Harian',
          sub_title: '  Menampilkan laporan progress produksi per hari',
          condition: 'progress-production',
          url: process.env.API_URL + "/report/manufactur/get-progres-produksi-harian"
        }
      ],
