                ...
                <table class="table table-striped table-sm vld-parent table-hover"
                  ...
                  <tbody>
                    <tr :class="{'table-active': ActiveRow == i }" v-for="(item,i) in data" :key="i"  @click="onRowSelected(i)">
                      ...
                      <td>{{ item.code }}</td>
                      <td>{{ item.name }}</td>
                      <td>{{ item.group_mesin ? item.group_mesin.code : '-' }}</td>  
                        <td>{{ item.speed}}</td>  
  ...
  computed : {
    ...
    getRoles(){
      if(!this.user.parent_id){
        ...
        let main_role = this.user.group_role.roles.find(item => item.name == "machine");
  ...
  methods : {
    ...
    onEdit(item){
      ...
      this.$refs["form-input"].parameters.form = {
        ...
        vendor_machine_id: item.vendor_machines,
