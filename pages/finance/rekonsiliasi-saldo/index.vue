...
export default {
  ...
  data() {
    return {
      ...
      isPaginate: true,
      parameters: {
        url: "finance/rekonsiliasi-saldo",
        type: "pdf",
        params: {
          soft_deleted: "",
          search: "",
          order: "rekonsiliasi_saldo_id",
          sort: "desc",
          all: "",
          per_page: 10,
          page: 1,
    ...
    getRoles() {
      if (this.user.is_superadmin == 1) {
        ...
        let main_role = this.user.role.menus.find(
          (item) => item.rute == "rekonsiliasi-saldo"
        );
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/finance/rekonsiliasi-saldo/add");
    },

    onDetail(item) {
      this.$router.push(
        "/finance/rekonsiliasi-saldo/detail/" + item.rekonsiliasi_saldo_id
      );
    },

    onEdit(item) {
      this.$router.push(
        "/finance/rekonsiliasi-saldo/" + item.rekonsiliasi_saldo_id
      );
    },
