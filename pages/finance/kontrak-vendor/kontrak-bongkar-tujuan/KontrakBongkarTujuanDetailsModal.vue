<template>
  <div v-if="showModal">
    ...
    <div
      ...
      aria-hidden="true"
      id="modal-bongkar-tujuan"
    >
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header flex justify-between text-xl font-bold mb-3">
            <h5 class="modal-title">Tambah Kontrak Bongkar Tujuan</h5>
...
export default {
  ...
  data() {
    return {
      ...
      isLoadingFormBongkarTujuan: false,
  ...
  methods: {
    async onSubmitBongkarTujuan(isInvalid) {
      if (isInvalid || this.isLoadingFormBongkarTujuan) return;

      this.isLoadingForm = true;
      let url;

      if (this.parameters.form.kontrak_bongkar_tujuan_detail_id) {
        url = `finance/kontrak-bongkar-tujuan/put-detail-kontrak-bongkar-tujuan/${this.parameters.form.kontrak_bongkar_tujuan_detail_id}`;
      } else {
        url = `finance/kontrak-bongkar-tujuan/post-detail-kontrak-bongkar-tujuan/${this.parameters.form.kontrak_bongkar_tujuan_id}`;
      }
      ...
      this.$axios({
        method: this.parameters.form.kontrak_bongkar_tujuan_detail_id
          ? "put"
          : "post",
        url: url,
        data: formData,
