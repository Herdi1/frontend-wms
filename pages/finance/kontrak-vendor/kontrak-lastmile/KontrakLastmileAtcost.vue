  ...
  <div>
    <div>
      <div class="w-full flex justify-between items-center">
        <h1 class="text-xl font-bold">Detail Biaya Lainnya</h1>
        <div class=" ">
          <button
            type="button"
            @click="addDetailAtcost"
                ...
                >
                  ...
                  >
                    <span
                      ...
                      @click="onGetLuas(search, false)"
                      class="flex-fill bg-primary text-white text-center cursor-pointer p-2 rounded"
                      >Sebelumnya</span
                    >
                    <span
                      v-if="lookup_roles.last_page > lookup_roles.current_page"
                      @click="onGetLuas(search, true)"
                      class="flex-fill bg-primary text-white text-center cursor-pointer p-2 rounded"
                      >Selanjutnya</span
                    >
                  </li>
                ...
                >
                  ...
                  >
                    <span
                      ...
                      @click="onGetWaktu(search, false)"
                      class="flex-fill bg-primary text-white text-center cursor-pointer p-2 rounded"
                      >Sebelumnya</span
                    >
                    <span
                      v-if="lookup_beam.last_page > lookup_beam.current_page"
                      @click="onGetWaktu(search, true)"
                      class="flex-fill bg-primary text-white text-center cursor-pointer p-2 rounded"
                      >Selanjutnya</span
                    >
                  </li>
...
export default {
  ...
  data() {
    return {
      ...
      isStopSearchLuas: false,
      isLoadingGetLuas: false,
      luas_search: "",
  ...
  methods: {
    ...
    onGetLuas(search, isNext) {
      if (!search.length && typeof isNext === "function") return false;

      clearTimeout(this.isStopSearchLuas);

      this.isStopSearchLuas = setTimeout(() => {
        this.luas_search = search;
    ...
    async onSearchLuas() {
      if (!this.isLoadingGetLuas) {
        this.isLoadingGetLuas = true;
        ...
        this.isLoadingGetLuas = false;
      }
    },

    onGetWaktu(search, isNext) {
      if (!search.length && typeof isNext === "function") return false;

      clearTimeout(this.isStopSearchWaktu);

      this.isStopSearchWaktu = setTimeout(() => {
        this.waktu_search = search;
    ...
    async onSearchWaktu() {
      if (!this.isLoadingGetWaktu) {
        this.isLoadingGetWaktu = true;
