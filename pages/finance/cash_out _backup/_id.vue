                    ...
                    <form @submit.prevent="() => console.log('Submit')"
                            ...
                            <div class="d-flex flex-row">
                                ...
                                <div class="col-sm-6"> 
                                    <div class="form-group">
                                         <div class="row">
                                                <div class="col-sm-2 align-self-center mr-0">
                                                    <label for="chart_of_account_id">Master Akun</label>
                                                </div>
                                                <div class="col-sm-10 align-self-center ml-0 pl-0">
                                                    <v-select                           
                                                        label="name"   
                        ...
                        <div class="table-responsive table-striped">                        
                            <table class="table table-sm mt-3">
                                ...
                                <tr v-for="item,index in form.cash_out_details"
                                    :key="index">
                                ...
                                <tr v-if="!form.cash_out_details.length">
                                    <td colspan="5"
...
export default {
    ...
    async created(){
        try{        
            if(this.isEditable){
                let response = await this.$axios.get("finance/cash_out/"+this.id);

                Object.keys(this.form)
                    .forEach(item => {
                        if(item != "cash_out_details"){
                ...
                this.form.cash_out_details = response.data
                    .cash_out_details
                    .map(item => {
                        return {
                            ...item,
            ...
            this.$router.push("/finance/cash_out");
        }
    },
    ...
    methods: {    
        ...
        async onSearchChartOfAccount(){
            if(!this.isLoadingGetChartOfAccount){
                ...
                await this.lookUp({    
                    url : "finance/cash_out/get-chart-of-account",
        ...
        onSubmit(isInvalid){
            ...
            if(!this.form.cash_out_details.length){
                this.$toaster.error("Detail Pengeluaraan Kas Masih Kosong");
                return;
            }

            this.isLoadingForm = true;

            let url = "finance/cash_out";
            ...
            formData.cash_out_details = formData
                .cash_out_details
                .map(item => {
                    return {
        ...
        addDetail(){
            if(parseInt(this.limit_item_transaction) <= this.form.cash_out_details.length){
                this.$toaster.error("Hanya " + this.limit_item_transaction + " batas item yang di perbolehkan");
                return;
            }

            this.form.cash_out_details.push({
                chart_of_account_id : '',
                amount : 0.00,
                description : ''
            })
        ...
        deleteDetail(indexItem){
            this.form.cash_out_details = this.form
                .cash_out_details
        ...
        countTotal(){
            this.form.amount = this.form.cash_out_details.reduce((itemPrev,itemNext) => parseFloat(itemPrev) + parseFloat(itemNext.amount),0);
        },
        ...
        onSetChartOfAccountDetail(index){
            let details = [
                ...this.form.cash_out_details
            ];

            let item = {
                ...this.form.cash_out_details[index],            
            };
           
            if(!item.chart_of_account_id) {
                this.form.cash_out_details[index].chart_of_account_id = '';
                return
            };
            ...
            if(chartOfAccounts.length < 2){
                ...
                this.form.cash_out_details = details.filter((_,indexItem) => index != indexItem);            
            }
        }
    }
}
