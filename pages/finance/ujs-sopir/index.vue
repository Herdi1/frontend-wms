                    ...
                    <div class="flex justify-between items-baseline">
                      ...
                      <div>
                        <i
                          ...
                          :class="
                            parameters.params.order == 'kode_ujs' &&
...
export default {
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/finance/ujs-sopir/add");
    },

    onEdit(item) {
      this.$router.push("/finance/ujs-sopir/" + item.ujs_sopir_id);
    },
