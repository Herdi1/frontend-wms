...
export default {
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/finance/posting-premi/add");
    },

    // onEdit(item) {
    //   this.$router.push("/finance/posting-premi/" + item.posting_premi_id);
    // },

    onDetail(item) {
      this.$router.push(
        `/finance/posting-premi/detail/${item.posting_premi_id}`
      );
    },
