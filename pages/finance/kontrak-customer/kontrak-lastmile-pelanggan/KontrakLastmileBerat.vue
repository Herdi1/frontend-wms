      ...
      <div>
        <div class="w-full flex justify-between items-center">
          <h1 class="text-xl font-bold">
            Detail Kontrak Lastmile Pelanggan Berat
          </h1>
          <div class=" ">
            <button
              type="button"
        ...
        <div class="table-responsive overflow-y-hidden mb-7">
          <table
            ...
            :class="
              this.self.parameters.form.kontrak_lastmile_berat_pelanggan_details
                .length
                ? 'mb-[300px]'
                : ''
            "
              ...
              <tr
                v-if="
                  !this.self.parameters.form
                    .kontrak_lastmile_berat_pelanggan_details.length > 0
                "
              >
...
export default {
  ...
  methods: {
    ...
    addDetailBerat() {
      this.self.parameters.form.kontrak_lastmile_berat_pelanggan_details.push({
        jenis_kontrak_id: "",
        divisi_id: "",
        jenis_biaya_id: "",
        gudang_id: "",
    ...
    deleteBerat(index) {
      this.self.parameters.form.kontrak_lastmile_berat_pelanggan_details =
        this.self.parameters.form.kontrak_lastmile_berat_pelanggan_details.filter(
