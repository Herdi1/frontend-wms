          ...
          >
            <div class="table-responsive overflow-y-hidden mb-7">
              <table
                ...
                :class="
                  parameters.form.kontrak_tkbm_pelanggan_details.length
                    ? 'mb-[300px]'
                    : ''
                "
              >
                ...
                <tbody>
                  <tr
                    v-for="(item, i) in parameters.form
                      .kontrak_tkbm_pelanggan_details"
                    :key="i"
                    class="border-t"
                  >
                    ...
                    <td class="border border-gray-300">
                      <v-select
                        ...
                        :filterable="false"
                        @search="onGetItem"
                        @input="(item) => onSelectItem(item, i)"
                  ...
                  <tr
                    v-if="
                      !parameters.form.kontrak_tkbm_pelanggan_details.length > 0
                    "
                  >
...
export default {
    ...
    try {
      if (this.isEditable) {
        ...
        Object.keys(this.parameters.form).forEach((item) => {
          if (item != "kontrak_tkbm_pelanggan_details") {
        ...
        this.parameters.form.kontrak_tkbm_pelanggan_details =
          res.data.kontrak_tkbm_pelanggan_details.map((item) => {
            return {
              ...item,
              kontrak_tkbm_pelanggan_details_id:
                item.kontrak_tkbm_pelanggan_details_id
                  ? item.kontrak_tkbm_pelanggan_details_id
                  : "",
  ...
  computed: {
    ...mapState("moduleApi", [
      ...
      "lookup_custom7", //term
      "lookup_custom8", //group
      "lookup_custom9", //satuan
      "lookup_custom10", //item
      "lookup_custom2", //pembayaran
      "lookup_beam", //mata uang
    ]),
  },
  ...
  methods: {
    ...
    addDetailTKBM() {
      this.parameters.form.kontrak_tkbm_pelanggan_details.push({
        jenis_kontrak_id: "",
        divisi_id: "",
        jenis_biaya_id: "",
        gudang_id: "",
    ...
    onDeleteTKBM(index) {
      this.parameters.form.kontrak_tkbm_pelanggan_details =
        this.parameters.form.kontrak_tkbm_pelanggan_details.filter(
    ...
    onSelectGudang(item, index) {
      if (item) {
        this.parameters.form.kontrak_tkbm_pelanggan_details[index].gudang_id =
          item;
        this.onSearchItem(index);
      } else {
        this.parameters.form.kontrak_tkbm_pelanggan_details[index].gudang_id =
          "";
        // this.parameters.form.kontrak_tkbm_pelanggan_details[index].item_gudang_id = "";
        // this.parameters.form.kontrak_tkbm_pelanggan_details[index].item_id = "";
        // this.parameters.form.kontrak_tkbm_pelanggan_details[index].satuan_id = "";
      }
    },
    ...
    async onSubmit(isInvalid) {
      ...
      formData.kontrak_tkbm_pelanggan_details =
        this.parameters.form.kontrak_tkbm_pelanggan_details.map((item) => {
          return {
            ...item,
            jenis_kontrak_id:
