  ...
  <section>
    ...
    <div class="gap-5">
      ...
      >
            ...
            <div
              class="flex w-full gap-5 justify-between items-end p-2 border border-gray-300 rounded-md"
            >
                ...
                <table class="table table-striped table-sm vld-parent table-hover"
                  ...
                  <tbody>           
                    <tr v-if="data.length">
                      ...
                      <td class="text-info">
                        {{raw_data.first_balance ? raw_data.first_balance.saldo : '' | formatPrice}}
                      </td>
                    ...
                    <tr v-if="data.length">
                      <td>
                        {{data[data.length-1] ? data[data.length-1].tanggal : '-'}}
                      </td>
                      <td>
                        {{coa_id ? coa_id.kode_coa : '-'}}
                      </td>
  ...
  computed : {
    ...
    getRoles(){
      if(!this.user.parent_id){
        ...
        let main_role = this.user.group_role.roles.find(item => item.name == "buku_besar");
  ...
  methods : {
    ...
    async onLoad(page = 1){
      ...
      let url = this.parameters.url + 
        "?page=1" +
        "&coa_id=" + this.parameters.params.coa_id +
