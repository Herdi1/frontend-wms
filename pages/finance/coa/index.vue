                    ...
                    <div class="flex justify-between items-baseline">
                      ...
                      <div>
                        <i
                          ...
                          :class="
                            parameters.params.order == 'kode_coa' &&
...
export default {
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/finance/coa/add");
    },

    onEdit(item) {
      this.$router.push("/finance/coa/" + item.coa_id);
    },

    onDetail(item) {
      this.$router.push(`/finance/coa/detail/${item.coa_id}`);
    },
