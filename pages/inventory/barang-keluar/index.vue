                ...
                <tr class="uppercase">
                  ...
                  >
                    <div class="flex justify-between items-baseline">
                      <div>Kode Barang Keluar</div>
                      <div>
                        <i
                          class="fas fa-caret-up"
                          :class="
                            parameters.params.order == 'kode_barang_keluar' &&
                    ...
                    <div class="flex justify-between items-baseline">
                      ...
                      <div>
                        <i
                          class="fas fa-caret-up"
                          :class="
                            parameters.params.order == 'pelanggan_id' &&
                            parameters.params.sort == 'asc'
                              ? ''
                              : 'light-gray'
                          "
                  ...
                  <!-- <th class="w-52 border border-gray-300">Lokasi</th> -->
...
export default {
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/inventory/barang-keluar/add");
    },

    onEdit(item) {
      this.$router.push("/inventory/barang-keluar/" + item.barang_keluar_id);
    },

    onDetail(item) {
      this.$router.push(
        "/inventory/barang-keluar/detail/" + item.barang_keluar_id
      );
    },
