        ...
        <div class="card-body">
          <div class="card-title">
            <div class="d-flex justify-content-between">
              <h6>
                {{ isEditable ? "Edit" : "Tambah" }} Pemakaian Bahan Penolong
              </h6>
   ...
   onGetProces(search, isNext) {
    ...
    onSubmit(isInvalid) {
      ...
      let formData = {
        ...this.form,
        production_detail_id :   
          typeof this.form.production_detail_id == "object" && this.form.production_detail_id
        ...
        warehouse_id : 
          typeof this.form.warehouse_id == "object"
            ...
            : "",     
        master_proces_id:
          typeof this.form.master_proces_id == "object" && this.form.master_proces_id
