...
export default {
    ...
    getRoles() {
      if (!this.user.parent_id) {
        ...
        let main_role = this.user.group_role.roles.find(
          (item) => item.name == "sent_to_production"
        );
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/inventory/sent_nonproduction/add");
    },

    onEdit(id) {
      this.$router.push("/inventory/sent_nonproduction/" + id);
    },
