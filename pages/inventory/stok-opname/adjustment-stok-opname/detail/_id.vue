      ...
      <div class="w-full">
        ...
        >
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 w-full gap-2 mt-10">
            <div class="flex w-full items-center">
              <label class="w-[40%] font-bold">Status Adjustment</label>
              <div class="border border-gray-300 rounded-md p-1 w-[60%]">
                {{
                  this.detail_opname.status_adjustment === "1"
                    ? "Approved"
                    : this.detail_opname.status_adjustment === "0"
                    ? "Menunggu"
                    : "-"
                }}
              </div>
            ...
            <div class="flex w-full items-center">
              ...
              <div class="border border-gray-300 rounded-md p-1 w-[60%]">
                {{
                  this.detail_opname.catatan_adjustment
                    ? this.detail_opname.catatan_adjustment
                    : "-"
                }}
              </div>
