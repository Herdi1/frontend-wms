            ...
            <table class="mb-5 border border-gray-300" ref="formContainer">
              <thead>
                <tr class="text-base uppercase text-nowrap">
                  ...
                  <th class="border border-gray-300">Kode Pick Order</th>
                  <th class="border border-gray-300">Tanggal</th>
                  <th class="border border-gray-300">Staff</th>
                  <th class="border border-gray-300">Peralatan</th>
              ...
              <tbody>
                <tr v-for="(item, i) in data" :key="i">
                  ...
                  <td class="border border-gray-300">
                    {{ item.staff ? item.staff.nama_staff : "-" }}
                  </td>
                  <td class="border border-gray-300">
...
export default {
  ...
  data() {
    return {
      ...
      isPaginate: true,
      parameters: {
        url: "inventory/pick-order-stok-transfer",
        type: "pdf",
        params: {
          soft_deleted: "",
          search: "",
          order: "pick_order_stok_transfer_id",
          sort: "desc",
          all: "",
          per_page: 10,
          page: 1,
    ...
    getRoles() {
      if (this.user.is_superadmin == 1) {
        ...
        let main_role = this.user.role.menus.find(
          (item) => item.rute == "pick-order-stok-transfer"
        );
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/inventory/stok-transfer/pick-order/add");
    },

    onEdit(item) {
      this.$router.push(
        "/inventory/stok-transfer/pick-order/" +
          item.pick_order_stok_transfer_id
      );
    },
        ...
        callback: async (confirm) => {
          if (confirm) {
            ...
            await this.deleteData({
              ...
              id: item.pick_order_stok_transfer_id,
