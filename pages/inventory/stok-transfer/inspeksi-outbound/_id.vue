            ...
            <div class="grid grid-cols-1 gap-1 w-[60%] mb-7">
              ...
              <div class="form-group">
                <input-horizontal
                  ...
                  inputWidth="w-[60%]"
                  :isHorizontal="true"
                  v-model="form.tanggal_inspeksi"
                  :required="true"
                />
              </div>
              <div class="form-group flex items-top">
                <label for="" class="w-[40%]">Catatan Inspeksi</label>
                <textarea
                  placeholder="Catatan"
              ...
              <div class="form-group">
                <input-horizontal
                  label="Nomor Surat Perintah Jalan"
                  type="text"
                  name="surat_jalan"
                  labelWidth="w-[40%]"
                  inputWidth="w-[60%]"
...
export default {
  data() {
    ...
    return {
      ...
      isLoadingForm: false,
      title: "Inspeksi Outbound Stok Transfer",
      url: "inventory/inspeksi-outbound-stok-transfer",
    ...
    try {
      if (this.isEditable) {
        let res = await this.$axios.get(
          `inventory/inspeksi-outbound-stok-transfer/${this.id}`
        );
      ...
      this.$router.push("/inventory/stok-transfer/inspeksi-outbound");
    }
  },
