...
export default {
    ...
    getRoles() {
      if (this.user.is_superadmin == 1) {
        ...
        let main_role = this.user.role.menus.find(
          (item) => item.rute == "inspeksi-outbound-stok-transfer"
        );
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/inventory/stok-transfer/inspeksi-outbound/add");
    },

    onEdit(item) {
      this.$router.push(
        "/inventory/stok-transfer/inspeksi-outbound/" + item.stok_transfer_id
      );
    },
