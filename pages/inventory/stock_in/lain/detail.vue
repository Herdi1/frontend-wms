        ...
        <div class="modal-content">
            ...
            <div class="modal-body">                            
              ...
              <div class="row">               
                ...
                <div class="col-md-4 form-group">
                  <label for="purchaseing_id">Refference Kode</label>
                  <div>{{ parameters.form.purchaseing ? parameters.form.purchaseing.code : '-' }}</div>
                </div>
                <div class="col-md-4 form-group">
              ...
              <div class="table-responsive">
                <table class="table table-sm">
                  ...
                  <tr v-for="item in parameters.form.stock_in_details"
                    :key="item.id">                  
                  ...
                  <tr v-if="!parameters.form.stock_in_details.length">
                    <td colspan="6"
                      class="text-center">
