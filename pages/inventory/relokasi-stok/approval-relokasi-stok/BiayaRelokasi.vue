<template>
  <div>
    <div class="w-full flex justify-between items-center">
      <h1 class="text-xl font-bold">Detail Biaya Relokasi</h1>
      <div class=" ">
        <button
          type="button"
    ...
    <div class="table-responsive overflow-y-hidden mb-7 min-h-[300px]">
      <table
        ...
        :class="
          self.parameters.form.biaya_mutasi_stok_details.length
            ? 'mb-[300px]'
            : ''
        "
      >
        ...
        <tbody>
          ...
          <tr v-if="!this.self.parameters.form.biaya_mutasi_stok_details">
...
export default {
  ...
  watch: {
    "self.parameters.form.biaya_mutasi_stok_details": {
      handler(newVal) {
        newVal.forEach((item) => {
          item.total =
  ...
  computed: {
    ...
    calculateTotal() {
      ...
      this.self.parameters.form.biaya_mutasi_stok_details.forEach((item) => {
  ...
  methods: {
    ...
    addDetailBiaya() {
      this.self.parameters.form.biaya_mutasi_stok_details.push({
    ...
    deleteDetailBiaya(index) {
      this.self.parameters.form.biaya_mutasi_stok_details =
        this.self.parameters.form.biaya_mutasi_stok_details.filter(
