                ...
                <tr class="uppercase">
                  ...
                  >
                    <div class="flex justify-between items-baseline">
                      <div>Kode Barang Masuk</div>
                      <div>
                        <i
                          class="fas fa-caret-up"
                          :class="
                            parameters.params.order == 'kode_barang_masuk' &&
...
export default {
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/inventory/barang-masuk/add");
    },

    onEdit(item) {
      this.$router.push("/inventory/barang-masuk/" + item.barang_masuk_id);
    },

    onDetail(item) {
      this.$router.push(
        "/inventory/barang-masuk/detail/" + item.barang_masuk_id
      );
    },
