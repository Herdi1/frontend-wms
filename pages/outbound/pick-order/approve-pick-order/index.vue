...
export default {
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/outbound/pick-order/approve-pick-order/add");
    },

    onEdit(item) {
      this.$router.push(
        "/outbound/pick-order/approve-pick-order/" + item.pick_order_id
      );
    },

    onDetail(item) {
      this.$router.push(
        "/outbound/pick-order/approve-pick-order/detail/" + item.pick_order_id
      );
    },
