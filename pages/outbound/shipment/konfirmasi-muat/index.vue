...
export default {
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/outbound/shipment/konfirmasi-muat/add");
    },

    onEdit(item) {
      this.$router.push(
        "/outbound/shipment/konfirmasi-muat/" + item.shipment_id
      );
    },

    onDetail(item) {
      this.$router.push(
        "/outbound/shipment/konfirmasi-muat/detail/" + item.shipment_id
      );
    },
