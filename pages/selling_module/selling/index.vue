                      ...
                      <td class="text-center">
                        <div class="btn-group border border-success">                         
                          ...
                          <button class="btn btn-sm" 
                            ...
                            v-if="(
                              !item.deleted_at && 
                              item.selling_returns_count == 0 && 
                              item.receivable_payments_count == 0 && 
                              item.delivery_orders_count == 0 && 
...
export default {
  ...
  computed : {
    ...
    getRoles(){
      if(!this.user.parent_id){
        ...
        let main_role = this.user.group_role.roles.find(item => item.name == "selling");
  ...
  methods : {
    ...
    onFormShow(){    
      this.$router.push("/selling_module/selling/add");
    },

    onEdit(id){
      this.$router.push("/selling_module/selling/"+id);
    },
    ...
    onPrintDetail(item){
      ...
      window.open(process.env.API_URL + "/selling_module/selling/get-print-detail/" + item.id + "?token="+token, '_blank');    
    },
