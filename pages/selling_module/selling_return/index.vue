                        ...
                        <span class="row m-0 p-0">
                          ...
                          <div class="col m-0 p-0">
                            <div
                              ...
                              style="font-size: 12px !important; color: dimgrey"
                            >
                              {{ item.selling ? item.selling.code : "-" }}
                            </div>
                          </div>
                        </span>
                        <div
...
export default {
  ...
  methods: {
    ...
    onFormShow() {
      this.$router.push("/selling_module/selling_return/add");
    },

    onEdit(id) {
      this.$router.push("/selling_module/selling_return/" + id);
    },
