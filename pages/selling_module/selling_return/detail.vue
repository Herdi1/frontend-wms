            ...
            <div class="receipt-main">
              ...
              <div class="row mt-2">
                ...
                <div class="col-md-6 float-right ">
                  <div class="receipt-right text-right">
                    ...
                    <p><b>No Penjualan :</b> {{ parameters.form.selling ? parameters.form.selling.code : '-' }}
                    </p>
              ...
              <div>
                <table class="table table-striped table-sm vld-parent mt-3">
                  ...
                  <tbody>
                    <tr v-for="item in parameters.form.selling_return_details" :key="item.id">
                    ...
                    <tr v-if="!parameters.form.selling_return_details.length">
