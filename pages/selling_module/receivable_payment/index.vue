                ...
                <table class="table table-striped table-sm vld-parent table-hover"
                  ...
                  <thead>
                    <tr>         
                      ...
                      <th>Dibayar</th>
                      <th @click="onSort('receivable',parameters.params.sort == 'asc' ? 'desc' : 'asc')"
                        class="cursor-pointer">
                        <div class="d-flex flex-row justify-content-between align-items-baseline">
                          <div>Kekurangan</div>
                          <div>
                            <i class="fas fa-caret-up"
                              :class="parameters.params.order == 'receivable' && parameters.params.sort == 'asc' ? '' : 'light-gray'"></i>
                            <i class="fas fa-caret-down"
                              :class="parameters.params.order == 'receivable' && parameters.params.sort == 'desc' ? '' : 'light-gray'"></i>
                          </div>
                        </div>
                      </th>                                            
                  ...
                  <tbody>
                    <tr :class="{'table-active': ActiveRow == i }" v-for="(item,i) in data" :key="i"  @click="onRowSelected(i)">
                      ...
                      <td>
                        {{ (parseFloat(item.grand_total) - parseFloat(item.receivable)) | formatPrice }}
                      </td>
                      <td>
                        {{ item.receivable | formatPrice }}
                      </td>
                      <td class="text-center">
                        <div class="btn-group border border-success">
                          <button class="btn btn-sm"                        
                            @click="onFormShow(item)"
                            v-if="getRoles.store">
  ...
  computed : {
    ...
    getRoles(){
      if(!this.user.parent_id){
        ...
        let main_role = this.user.group_role.roles.find(item => item.name == "receivable_payment");
