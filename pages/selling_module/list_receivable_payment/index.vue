                ...
                <table class="table table-striped table-sm vld-parent table-hover"
                  ...
                  <tbody>
                    <tr :class="{'table-active': ActiveRow == i }" v-for="(item,i) in data" :key="i"  @click="onRowSelected(i)">
                      ...
                      <td>{{ item.date }}</td>
                      <td>                    
                        Kode Penjualaan : {{ item.selling ? item.selling.code : '-'}}
                        <div v-if="item.selling">
                          Pelanggan : {{ item.selling.customer ? item.selling.customer.name : '-'}}
                        </div>            
                        <div>
...
export default {
  ...
  data() {
    return {
      ...
      ActiveRow           : null,
      parameters : {
        url : 'selling_module/list_receivable_payment',
        type : 'pdf',
        params :{
          soft_deleted : '',
          search      : '',
  ...
  computed : {
    ...
    getRoles(){
      if(!this.user.parent_id){
        ...
        let main_role = this.user.group_role.roles.find(item => item.name == "list_receivable_payment");
