            ...
            >
                    ...
                    <div class="flex justify-between items-baseline">
                      ...
                      <div>
                        <i
                          class="fas fa-caret-up"
                          :class="
                            parameters.params.order == 'lokasi_id_asal' &&
                            parameters.params.sort == 'asc'
                              ? ''
                              : 'light-gray'
                          "
                    ...
                    <div class="flex justify-between items-baseline">
                      ...
                      <div>
                        <i
                          class="fas fa-caret-up"
                          :class="
                            parameters.params.order == 'lokasi_id_tujuan' &&
                            parameters.params.sort == 'asc'
                              ? ''
                              : 'light-gray'
                          "
              ...
              <tbody>
                <tr v-for="(item, i) in data" :key="i">
                  ...
                  <td class="border border-gray-300">
                    {{
                      item.shipment.kendaraan
                        ? item.shipment.kendaraan.nama_kendaraan +
                          " - " +
                          item.shipment.kendaraan.kode_kendaraan
                        : ""
                    }}
                  </td>
                  <td class="border border-gray-300">
                    {{
                      item.shipment.staff
                        ? item.shipment.staff.nama_lengkap +
                          " - " +
                          item.shipment.staff.kode_staff
                        : ""
                    }}
                  </td>
                  <td class="place-items-center border border-gray-300">
