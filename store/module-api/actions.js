export default {
    ...
    deleteAllData({ commit, dispatch }, payload) {
        return this.$axios
            .delete("/" + payload.url + "/destroy-all", {
                data: {
    ...
    restoreData({ commit, dispatch }, payload) {
        return this.$axios
            .post("/" + payload.url + "/restore/" + payload.id)
            .then((response) => {
                commit("set_result", true);
            })
            .catch((error) => {
    ...
    getCode({ commit, dispatch }, payload) {
        return this.$axios
            .get("/" + payload.url + "/get-code" + (payload.query || ""))
            .then((response) => {
                commit("set_result", true);
            ...
            .then((response) => {
                ...
                switch (payload.lookup) {
                    case "roles":
                        ...
                        break;
                        // case "roles_2":
                        //   commit("set_lookup_roles_2", response.data);
                        //   break;
                    case "group_roles":
